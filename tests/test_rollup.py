    ...
    def sample_protein_groups(self):
        ...
        groups = [
            ProteinGroup(
                ...
                leading_uniprot_id="UP001",
                leading_gene_name="GENE1",
                leading_description="Single Peptide Protein",
            ...
            ProteinGroup(
                ...
                leading_uniprot_id="UP002",
                leading_gene_name="GENE2",
                leading_description="Two Peptide Protein",
            ...
            ProteinGroup(
                ...
                leading_uniprot_id="UP003",
                leading_gene_name="GENE3",
                leading_description="Three Peptide Protein",
            ...
            ProteinGroup(
                ...
                leading_uniprot_id="UP005",
                leading_gene_name="GENE5",
                leading_description="Five Peptide Protein",
    ...
    def test_zero_peptide_protein_skipped(self):
        ...
        groups = [
            ProteinGroup(
                ...
                leading_uniprot_id="UP_EMPTY",
                leading_gene_name="GENE_EMPTY",
                leading_description="Empty Protein",
            ...
            ProteinGroup(
                ...
                leading_uniprot_id="UP_DATA",
                leading_gene_name="GENE_DATA",
                leading_description="Has Data Protein",
...
class TestProteinLevelBatchCorrection:
    ...
    def protein_batch_data(self):
        ...
        for i, sample in enumerate(sample_names):
            batch = sample_metadata.loc[sample_metadata["replicate_name"] == sample, "batch"].iloc[
                0
            ]
    ...
    def test_batch_correct_proteins_reduces_batch_effect(self, protein_batch_data):
        ...
        sample_cols = [
            ...
            if c not in ["leading_protein", "leading_name", "n_peptides", "n_unique_peptides"]
        ]
        ...
        def batch_variance(df, cols, metadata):
            ...
            for batch in metadata["batch"].unique():
                batch_samples = metadata.loc[metadata["batch"] == batch, "replicate_name"].tolist()
    ...
    def test_protein_output_pipeline(self, protein_batch_data):
        ...
        for prot_idx in range(n_proteins):
            ...
            group = ProteinGroup(
                ...
                leading_uniprot_id=f"UP{prot_idx:05d}",
                leading_gene_name=f"GENE{prot_idx}",
                leading_description=f"Protein {prot_idx}",
